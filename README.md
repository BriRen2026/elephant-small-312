...
7. Find the sidebar of fashion item icon boxes to the left of the elephant. Click one of the icon boxes, and confirm that the corresponding fashion item on the elephant disappears.
     * 6a. Repeat deleting as many icon boxes as desired, with the constraint that at least one fashion item must remain on the elephant at the end of this step.
...
11. Confirm that the most recently posted elephant is dressed up to the expected extent (based on steps 5 and 6).
