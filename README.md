...
3. At the top right of the home page, click "Register" to make a new account. Enter a valid username and password (both must be unique and non-empty strings). When your registration is validated, you will be automatically logged in.
...
6. Navigate to any of the five menus (Head, Face, Pets, Shoes, Accessories). Choose one of the fashion items; drag and drop it onto the image of your chosen elephant.
     ...
     * 6b. Repeat steps 5 and 5a as many times as desired. If 10 items are placed on the elephant, attempt to drag an 11th item onto the elephant, and confirm that an alert pops up instead of dropping the element.
...
11. Confirm that the most recently posted elephant is dressed up to the expected extent (based on steps 5 and 6). Confirm that the username you registered an account with appears at the top right of the elephant post.
